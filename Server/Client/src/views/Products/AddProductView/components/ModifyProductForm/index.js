            ...
            <div class="card-body">   
                ...
                <form /*onSubmit={handleFormSubmit}*/ name="addProductForm" id="addProductForm">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value={product.nombre} name="nombre" id="nombre"  maxlength="50" required/>
                    </div>
                    <div class="form-group">
                        <label for="inputDescripcionProd" class="form-label">Descripción del producto</label>
                        <textarea class="form-control" value={product.descripcion} name="descripcion" id="descripcion"  maxlength="500" required></textarea>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="inputPrecio" class="form-label">Precio</label>
                            <div class="input-group mb-3">
                                <input type="number" value={product.precio} class="form-control"  name="precio" id="precio" min="0" step="0.01"  required/>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group mb-3">
                                <input type="number" value={product.descuento*100} class="form-control" name="descuento" id="descuento" min="0" max="100"  required/>
                                <span class="input-group-text">%</span>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="number" value={product.cantidad} class="form-control" name="cantidad" id="cantidad"  min="0" required/>
                    </div>
                    <div>
